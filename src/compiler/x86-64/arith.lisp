...
(define-modular-fun %negate-mod64 (x) %negate :untagged t 64)
(define-vop (%negate-mod64 fast-negate/signed)
  (:translate %negate-mod64))
(define-modular-fun %negate-umod64 (x) %negate :untagged nil 64)
(define-vop (%negate-umod64)
  (:translate %negate-umod64)
  (:policy :fast-safe)
  (:args (x :scs (unsigned-reg) :target r))
  (:arg-types unsigned-num)
  (:results (r :scs (unsigned-reg)))
