...
(macrolet ((define-frame-op
  ...
  (define-frame-op signed-byte-64 signed-reg signed-stack
    mov/raw)
  (define-frame-op unsigned-byte-64 unsigned-reg unsigned-stack
    mov/raw)
  (define-frame-op system-area-pointer sap-reg sap-stack
    mov/raw))
